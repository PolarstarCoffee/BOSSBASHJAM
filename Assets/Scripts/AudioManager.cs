...
public class AudioManager : MonoBehaviour
{
    ...
    public void ChangeSong(string musicClipName)
    {
        SoundsFadeOut();
        ...
        AudioManager.Instance().PlaySound("soundName"); // plays a sound once
        AudioManager.Instance().ChangeSong("songName"); // changes the current looping song
    }
